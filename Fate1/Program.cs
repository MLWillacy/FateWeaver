...
class FateWeaver
{
    ...
    static void Main(string[] args)
    {
        ...
        double killPercent2 = test.KillChance(test.Attacker.Weapons[1]);
        ...
        Console.WriteLine(test.Attacker.Name + " has a " + killPercent2 + "% chance to kill " + test.Defender.Name + " with weapon " + test.Attacker.Weapons[1].Name);
